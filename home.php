        ...
        <div class="container">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <p>E Career Gateway is the #1 job site in the world1 with over 25 crore unique visitors2 every month. E Career strives to put job seekers first, giving them free access to search for jobs, post resumes, and research companies. Every day, we connect millions of people to new opportunities.</p>
              </div>
              <div class="col-md-4">
                <div class="block-heading-two">
                  ...
                  <!-- Panel heading -->
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>1. Post your job for free in 5 minutes*
                      </a>
                    </h4>
                   </div>
                   <div id="collapseOne-alt3" class="panel-collapse collapse">
                    ...
                    <div class="panel-body">
                      Just create an account and enter your job description to post jobs for free.
                    </div>
                   </div>
                  </div>
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>2. Sponsor your jobs to attract more candidates
                      </a>
                    </h4>
                   </div>
                   <div id="collapseTwo-alt3" class="panel-collapse collapse">
                    <div class="panel-body">
                      As thousands of jobs are added to E Career each day, free job postings lose visibility. To hire faster, pay to promote your postings as Sponsored Jobs.
                    </div>
                   </div>
                  </div>
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i> 3. Manage your candidates
                      </a>
                    </h4>
                   </div>
                   <div id="collapseThree-alt3" class="panel-collapse collapse">
                    <div class="panel-body">
                      You’ll receive applications via email. You can also manage jobs and candidates from your E Career dashboard.
                  ...
                  <div class="panel">
                   <div class="panel-heading">
                    <h4 class="panel-title">
                      ...
                      <i class="fa fa-angle-right"></i>4. Find the right fit
                      </a>
                    </h4>
                   </div>
                   <div id="collapseFour-alt3" class="panel-collapse collapse">
                    <div class="panel-body">
                      Update your job description or budget any time to drive more people to your jobs and convert them to applies.

Attract best-fit talent with your free Company Page, or find the exact candidates you need by searching on E Career Resume.
                    </div>
                   </div>
                  </div>
                </div>
                ...
                <div class="block-heading-two">
                  <h3><span>Testimonials</span></h3>
                    ...
                    <div class="active item">
                      <blockquote><p>E Career Gateway is the Best Online Job Portal in 21st Century.It was Developed by Great Team.</p></blockquote>
                      <div class="carousel-info">
                    
                      <div class="pull-left">
                        <span class="testimonials-name">Sahithi R</span>
