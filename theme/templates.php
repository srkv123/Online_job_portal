  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No. (+91) 9888086088 </p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">E Career Gateway<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          BMS college of engineering <br>
           Pin-560006 Bangalore Karnataka.</address>
          <p>
            <i class="icon-phone"></i> (91) 9108665795 <br>
            <i class="icon-envelope-alt"></i>rsahithi2002@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; SS 2021 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
